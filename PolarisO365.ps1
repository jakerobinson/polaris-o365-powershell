...
function Get-PolarisO365MailboxUser() {
    ...
    Returns a filtered list of O365 Mailbox users for a given subscription in a given Polaris instance.

    .DESCRIPTION

    Returns a filtered list of Office 365 Mailbox users from a given subscription and Polaris instance, taking
...
function Get-PolarisO365OneDriveUser() {
    <#
    .SYNOPSIS
